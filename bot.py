...
def generate_image_gigachat(prompt):
    ...
    data = {
        "model": "GigaChat-Image",  # предполагаемое название модели, может быть "Kandinsky" или другое
        "prompt": prompt,
        "size": "1024x1024",
        "n": 1
    }
...
def generate_image_pollinations(prompt):
    ...
    try:
        ...
        log(f"   URL: {url[:60]}...")
        # Проверяем доступность, делаем HEAD-запрос
